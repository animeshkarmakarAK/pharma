    ...
    <div class="container-fluid">
                                    ...
                                    <div class='row'>
                                        <div class='col-md-6'>
                                            ...
                                            @if($slider->is_button_available == \App\Models\Slider::IS_BUTTON_AVAILABLE_YES && !empty($slider->link))
                                                <a href='{{route('static-content.show', $slider->link)}}'
        ...
        <section class="template-news">
            ...
            @if(!empty($currentInstituteCourses->count() >= 8))
                <div class="col-md-12 text-center margin-10">
                    <a href="{{ route('course_search') }}" class="service-box-button">
                        আরও কোর্স খুঁজুন</a>
                </div>
            @endif
        </section>
        ...
        <section class="template-news">
            ...
            @if(!empty($galleryCategories->count() >= 4))
                <div class="col-md-12 text-center margin-10">
                    <a href="{{ route('gallery-categories') }}" class="service-box-button">
