...
<div class="wrapper">
    @yield('header', \Illuminate\Support\Facades\View::make('master::layouts.partials.smef-front-end.header'))
    ...
    @yield('footer', \Illuminate\Support\Facades\View::make('master::layouts.partials.smef-front-end.footer'))
</div>
