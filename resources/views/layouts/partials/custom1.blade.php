...
<div class="wrapper">
    @yield('header', \Illuminate\Support\Facades\View::make('core.front-end.layouts.custom1.header'))
    ...
    @yield('footer', \Illuminate\Support\Facades\View::make('core.front-end.layouts.custom1.footer'))
</div>
