@php
    ...
    if($authYouth){
        $youthSelfInfo = \App\Models\YouthFamilyMemberInfo::where(['youth_id'=>$authYouth->id, 'relation_with_youth'=>'self'])->first();
    }
...
@section('content')
    <div class="container-fluid">
        <div class="row">
                            ...
                            @if(!$authYouth)
                                <div class="text-info text-center">
                                    আপনি যদি পূর্বে নিবন্ধন করে থাকেন তাহলে <a
                                        href="{{ route('youth.login-form') }}">লগইন</a> করে কোর্স এ
                                    আবেদন করুন
                                </div>
                            @endif
            ...
            <form action="{{ route('youth-registrations.store') }}" method="POST"
                                ...
                                @if(!empty($publishCourse))
                                    <div class="form-group col-md-6 freedom-fighter-status-information">
                                        ...
                                        <select name="freedom_fighter_status" id="freedom_fighter_status"
                                                class="select2">
                                            <option value=""></option>
                                            @foreach(\App\Models\YouthFamilyMemberInfo::getFreedomFighterStatusOptions() as $key=>$value)
                                                <option
                                    ...
                                    <div class="input-group form-control">
                                        ...
                                        <div class="custom-control custom-radio mr-3">
                                            <input type="radio" name="disable_status"
                                                   ...
                                                   id="physically_not_disable" {{ old('disable_status') == \App\Models\YouthFamilyMemberInfo::PHYSICALLY_DISABLE_NOT ? 'checked' : '' }}>
                                        ...
                                        <div class="input-group">
                                            <div class="custom-control custom-radio d-inline-block mr-3">
                                                <input type="radio" name="ethnic_group"
                                                       class="custom-control-input"
                                                       value="{{ \App\Models\Youth::ETHNIC_GROUP_YES }}"
                                                       id="ethnic_group_yes" {{ old('ethnic_group') == \App\Models\Youth::ETHNIC_GROUP_YES? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ethnic_group_yes">হ্যাঁ</label>
                                            </div>
                                            <div class="custom-control custom-radio d-inline-block mr-3">
                                                <input type="radio" name="ethnic_group"
                                                       class="custom-control-input"
                                                       value="{{ \App\Models\Youth::ETHNIC_GROUP_NO }}"
                                                       id="ethnic_group_no" {{ old('ethnic_group') == \App\Models\Youth::ETHNIC_GROUP_NO? 'checked' : '' }}>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-control custom-radio d-inline-block mr-3">
                                                    <input type="radio" name="current_employment_status"
                                                           class="custom-control-input"
                                                           value="{{ \App\Models\YouthRegistration::CURRENT_EMPLOYMENT_STATUS_YES }}"
                                                           id="currently_employed_yes" {{ old('current_employment_status') == \App\Models\YouthRegistration::CURRENT_EMPLOYMENT_STATUS_YES ? 'checked' : '' }}>
                                                ...
                                                <div class="custom-control custom-radio d-inline-block mr-3">
                                                    <input type="radio" name="current_employment_status"
                                                           class="custom-control-input"
                                                           value="{{ \App\Models\YouthRegistration::CURRENT_EMPLOYMENT_STATUS_NO }}"
                                                           id="currently_employed_no" {{ old('current_employment_status') == \App\Models\YouthRegistration::CURRENT_EMPLOYMENT_STATUS_NO ? 'checked' : '' }}>
                                                ...
                                                <div class="input-group form-control">
                                                    <div class="custom-control custom-radio mr-3">
                                                        <input class="custom-control-input" type="radio"
                                                               value="{{ \App\Models\YouthFamilyMemberInfo::GUARDIAN_FATHER }}"
                                                               id="guardian-father"
                                                               name="guardian" {{ old('guardian') == \App\Models\YouthFamilyMemberInfo::GUARDIAN_FATHER ? 'checked' : ''}}>
                                                    ...
                                                    <div class="custom-control custom-radio mr-3">
                                                        <input class="custom-control-input" type="radio"
                                                               value="{{ \App\Models\YouthFamilyMemberInfo::GUARDIAN_MOTHER }}"
                                                               id="guardian-mother"
                                                               name="guardian" {{ old('guardian') == \App\Models\YouthFamilyMemberInfo::GUARDIAN_MOTHER ? 'checked' : ''}}>
                                                    ...
                                                    <div class="custom-control custom-radio mr-3">
                                                        <input class="custom-control-input" type="radio"
                                                               value="{{ \App\Models\YouthFamilyMemberInfo::GUARDIAN_OTHER }}"
                                                               id="guardian-other"
                                                               name="guardian" {{ old('guardian') == \App\Models\YouthFamilyMemberInfo::GUARDIAN_OTHER ? 'checked' : ''}}>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox ml-2">
                                        <input class="custom-control-input" type="checkbox"
                                               ...
                                               value="{{ \App\Models\YouthRegistration::HAVE_FAMILY_OWN_HOUSE }}" {{ old('have_family_own_house') == \App\Models\YouthRegistration::HAVE_FAMILY_OWN_HOUSE ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox ml-2">
                                        <input class="custom-control-input" type="checkbox"
                                               ...
                                               value="{{ \App\Models\YouthRegistration::HAVE_FAMILY_OWN_LAND }}" {{ old('have_family_own_land') == \App\Models\YouthRegistration::HAVE_FAMILY_OWN_LAND ? 'selected' : ''}}>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox ml-2">
                                        <input class="custom-control-input" type="checkbox"
                                               ...
                                               value="{{ \App\Models\YouthRegistration::RECOMMENDED_BY_ORGANIZATION }}" {{ old('recommended_by_organization') == \App\Models\YouthRegistration::RECOMMENDED_BY_ORGANIZATION ? 'selected' : '' }}>
...
@push('js')
    ...
    <script>
        ...
        const GUARDIAN_INFO_OTHER = {!! \App\Models\YouthFamilyMemberInfo::GUARDIAN_OTHER !!};
        ...
        youthRegistrationForm.validate({
            ...
            rules: {
                ...
                physical_disabilities: {
                    required: function () {
                        return $("input[name = 'disable_status']:checked").val() == {!! \App\Models\YouthFamilyMemberInfo::PHYSICALLY_DISABLE_YES !!};
                    }
                },
                nid: {
                    required: function () {
                    ...
                    nidBn: true,
                    remote: "{!! route('youth.check-unique-nid') !!}",
                ...
                birth_certificate_no: {
                    ...
                    birthRegNo: true,
                    remote: "{!! route('youth.check-unique-birth_certificate_no') !!}"
                },
                passport_number: {
                    required: function () {
                    ...
                    passport: true,
                    remote: "{!! route('youth.check-unique-passport-no') !!}"
                },
                ...
                "academicQualification[ssc][grade]": {
                    ...
                    min: 1,
                    max: function () {
                        if ($('#ssc_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FOUR !!}) {
                            return 4
                        }
                        if ($('#ssc_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FIVE !!}) {
                            return 5;
                        }
                    },
                },
                ...
                "academicQualification[hsc][grade]": {
                    ...
                    min: 1,
                    max: function () {
                        if ($('#hsc_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FOUR !!}) {
                            return 4
                        }
                        if ($('#hsc_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FIVE !!}) {
                            return 5;
                        }
                    },
                },
                ...
                "academicQualification[graduation][grade]": {
                    ...
                    min: 1,
                    max: function () {
                        if ($('#graduation_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FOUR !!}) {
                            return 4
                        }
                        if ($('#graduation_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FIVE !!}) {
                            return 5;
                        }
                    },
                },
                ...
                "academicQualification[masters][grade]": {
                    ...
                    min: 1,
                    max: function () {
                        if ($('#masters_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FOUR !!}) {
                            return 4
                        }
                        if ($('#masters_result').val() == {!! \App\Models\YouthAcademicQualification::EXAMINATION_RESULT_GPA_OUT_OF_FIVE !!}) {
                            return 5;
                        }
                    },
                },
                ...
                "familyMember[guardian][member_name_en]": {
                    required: function () {
                        return $("input[name = 'guardian']:checked").val() == {!! \App\Models\YouthFamilyMemberInfo::GUARDIAN_OTHER !!};
                    },
                    textEnBnWithoutSpecialChar: true,
                },
        ...
        const applicationFormTypeFetch = searchAPI({
            model: "{{base64_encode(\App\Models\ApplicationFormType::class)}}",
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'post',
                url: '{{route('publish-course-training-centers')}}',
            ...
            $("input[name='disable_status']").change(function () {
                ...
                if (checkedValue == {!! \App\Models\YouthFamilyMemberInfo::PHYSICALLY_DISABLE_NOT !!}) {
                    $("#physical_disabilities").parent().hide();
                } else {
            ...
            $("input[name = 'guardian']").on('change', function () {
                if ($(this).val() == {!! \App\Models\YouthFamilyMemberInfo::GUARDIAN_OTHER !!}) {
                    ;
