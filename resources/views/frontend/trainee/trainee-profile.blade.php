                            ...
                            <div class="col-md-8 col-offset-md-1">
                                ...
                                <div class="text-muted">
                                    ...
                                    <p class="profile-info-p">{{ __('generic.address') }}
                                        : {{ optional($trainee->locUpazila)->title}}
                                        / {{ optional($trainee->locDistrict)->title }}
                                        / {{ optional($trainee->locDivision)->title }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span
                                                class="ml-2 font-weight-bold">{{ __('generic.relation') }}:</span> {{ $guardian->relation_with_trainee }}
                                        </div>
