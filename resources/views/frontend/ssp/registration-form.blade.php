                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="title" title="title" id="title"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="contact_person_name"
                                                   ...
                                                   placeholder="{{ __('generic.name') }}" value="{{ old('contact_person_name') }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label
                                            ...
                                            <input type="text" class="form-control" name="contact_person_post"
                                                   ...
                                                   placeholder="{{ __('generic.post') }}" value="{{ old('contact_person_post') }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label
                                            ...
                                            <input type="text" class="form-control" name="contact_person_email"
                                                   ...
                                                   placeholder="{{ __('generic.email') }}" value="{{ old('contact_person_email') }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label
                                            ...
                                            <input type="text" class="form-control" name="contact_person_mobile"
                                                   ...
                                                   placeholder="{{ __('generic.mobile') }}" value="{{ old('contact_person_mobile') }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label
