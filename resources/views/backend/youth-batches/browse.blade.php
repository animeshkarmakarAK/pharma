                            ...
                            <form class="row bulk-import-youth" id="import-youth-form" method="post"
                                ...
                                <div class="col-md-6 py-2 mb-2">
                                    <div class="form-group">
                                        <label for="import_youth_file" class="form-label">{{ __('admin.youth_batches.import_trainee')  }}</label>
                                ...
                                <div class="col-md-3 py-2 mb-2">
                                    <div class="form-group row">
                                        ...
                                        <button class="form-control form-control-lg bg-blue" id="import_youth_btn">
                                            {{ __('admin.youth_batches.import_now')  }}
                                        </button>
                                    </div>
                                </div>
                                <div class="col-md-3 py-2 mb-2 text-center">
                                    <div class="form-group row">
                                        ...
                                        <a href="{{asset('/assets/demoExcelFormat/backlog-demo.xlsx')}} "
                                           class="form-control form-control-lg bg-info"> {{ __('admin.youth_batches.download_demo')  }}</a>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(function () {
            let params = serverSideDatatableFactory({
                ...
                columns: [
                    ...
                    {
                        title: "{{ __('admin.youth_batches.trainee_reg_no')  }}",
        ...
        $(document).ready(function () {
            $("#import-youth-form").on("submit", function (event) {
                ...
                $.ajax({
                    url: "{{route('admin.batches.youths-import',$batch->id)}}",
                    type: "POST",
                    data: formData,
                    async: false,
                    cache: false,
