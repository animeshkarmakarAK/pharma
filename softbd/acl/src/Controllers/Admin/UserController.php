...
namespace Softbd\Acl\Controllers\Admin;
...
use Softbd\Acl\Services\UserService;

class UserController extends BaseController
{
    const  VIEW_PATH = "softbd-acl::users.";
    ...
    public function create(): string
    {
        ...
        return \Illuminate\Support\Facades\View::make('softbd-acl::users.edit-add', ['user' => $user])->render();
    }
    ...
    {
        return \Illuminate\Support\Facades\View::make('softbd-acl::users.read', ['user' => $user])->render();
    }
