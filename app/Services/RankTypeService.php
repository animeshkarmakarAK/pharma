...
class RankTypeService
{
    ...
    public function getRankTypeLists(Request $request): JsonResponse
    {
        ...
        /** @var Builder|RankType $rankTypees */
        $rankTypees = RankType::select(
            [
                'rank_types.id',
                'rank_types.title_en',
                'rank_types.title_bn',
        ...
        $rankTypees->leftJoin('organizations', 'rank_types.organization_id', '=', 'organizations.id');

        return DataTables::eloquent($rankTypees)
