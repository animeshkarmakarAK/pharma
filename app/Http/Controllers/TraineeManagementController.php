...
class TraineeManagementController extends Controller
{
    ...
    public function importTrainee(Request $request)
    {
    ...
    public function traineeCertificateList($traineeId)
    {
    ...
    public function traineeCertificateCourseWise(TraineeCourseEnroll $traineeCourseEnroll)
    {
        ...
        //return Storage::download($pdf->generateCertificate($template, $traineeInfo));
    }
}
