...
class SliderPolicy extends BasePolicy
{
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('view_any_slider');
    }
    ...
    public function view(User $user, Slider $slider)
    {
        if ($user->isInstituteUser()) {
            return $user->institute_id == $slider->institute_id && $user->hasPermission('view_single_slider');
        }
    ...
    {
        if ($user->isInstituteUser()) {
            return $user->institute_id == $slider->institute_id && $user->hasPermission('update_slider');
        }
    ...
    {
        if ($user->isInstituteUser()) {
            return $user->institute_id == $slider->institute_id && $user->hasPermission('delete_slider');
        }
    ...
    {
        if ($user->isInstituteUser()) {
            return $user->institute_id == $slider->institute_id && $user->hasPermission('restore_slider');
        }
    ...
    {
        if ($user->isInstituteUser()) {
            return $user->institute_id == $slider->institute_id && $user->hasPermission('force_delete_slider');
        }
