...
class VideoCategoryPolicy extends BasePolicy
{
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('view_any_video_category');
    }
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('view_single_video_category');
    }
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('create_video_category');
    }
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('update_video_category');
    }
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('delete_video_category');
    }
    ...
    {
        return $user->isInstituteUser() || $user->hasPermission('force_delete_video_category');
    }
}
