                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="profile-box">
                                <img
                                    ...
                                    alt="icon">
                                <h4><span>{{ $institute['courses'] ? $institute['courses'] :'0' }} টি+ </span> বিষয়ে প্রশিক্ষণ প্রদান</h4>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="profile-box">
                                <img src="https://pngimage.net/wp-content/uploads/2018/05/configuration-icon-png-4.png"
                                     alt="icon">
                                <h4><span>{{ $institute['youth_registrations'] ? $institute['youth_registrations'] :'0' }} টি+ </span> যুবক প্রশিক্ষন গ্রহন করেছেন</h4>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="profile-box">
                                <img
                                    ...
                                    alt="icon">
                                <h4><span>{{ $institute['training_centers'] ? $institute['training_centers'] :'0' }} টি+ </span> প্রশিক্ষণ কেন্দ্রে</h4>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="profile-box">
                                <img src="https://static.thenounproject.com/png/36971-200.png" alt="icon">
                                <h4><span>{{ $institute['training_centers'] ? $institute['training_centers'] :'0' }} টি+ </span> দক্ষ প্রশিক্ষক</h4>
                            </div>
                        </div>
