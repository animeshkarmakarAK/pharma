...
@section('title')
    {{__('course_management::admin.examination_result.list')}}
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-primary custom-bg-gradient-info">
                        <h3 class="card-title font-weight-bold">{{__('course_management::admin.examination_result.list')}}</h3>

                        <div class="card-tools">
                            @can('create', \Module\CourseManagement\App\Models\ExaminationResult::class)
                                <a href="{{route('course_management::admin.examination-results.create')}}"
    ...
    <script>
        $(function () {
            let params = serverSideDatatableFactory({
                url: '{{route('course_management::admin.examination-results.datatable')}}',
                order: [[2, "desc"]],
                columns: [
                    {
                        title: '{{__('course_management::admin.examination_result.sl')}}',
                        data: null,
                        defaultContent: "SL#",
                        searchable: false,
                        orderable: false,
