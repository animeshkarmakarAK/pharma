                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="training_center_id">
                                        {{__('course_management::admin.examination_routine.training_center')}}
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="batch_id">
                                        {{__('course_management::admin.examination_routine.batch_title')}}
                                        <span style="color: red">*</span>
                                    </label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label
                                        for="date">{{__('course_management::admin.examination_routine.date')}}
                                        <span style="color: red">*</span>
                                    </label>
