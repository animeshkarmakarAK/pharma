...
@section('title')
    {{ __('course_management::admin.videos.list') }}
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-primary custom-bg-gradient-info">
                        <h3 class="card-title font-weight-bold"> {{ __('course_management::admin.videos.list') }}</h3>
        ...
        $(function () {
            let params = serverSideDatatableFactory({
                ...
                columns: [
                    ...
                    {
                        title: " {{ __('course_management::admin.videos.title') }}",
                        data: "title_en",
                        name: "title_en"
                    },
                    {
                        title: " {{ __('course_management::admin.videos.institute_name') }}",
                        data: "institute_name",
                        name: "institutes.title_en",
                        visible: false,
                    },
                    {
                        title: " {{ __('course_management::admin.videos.video_category') }}",
                    ...
                    {
                        title: "{{ __('course_management::admin.videos.description') }}",
                        data: "description",
