                ...
                <div class="card card-outline">
                    ...
                    <div class="card-body">
                        <form class="row edit-add-form" method="post"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="publish_course_id">{{ __('Publish Course Name') }} <span
                                            style="color: red">*</span></label>
                                    <select class="form-control select2-ajax-wizard"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="course_coordinator_signature"
                                           ...
                                           value="{{ $edit ? $batch->course_coordinator_signature : old('course_coordinator_signature') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="course_director_signature"
                                           ...
                                           value="{{ $edit ? $batch->course_director_signature : old('course_director_signature') }}">
                                </div>
                            </div>
