...
@section('title')
    {{ __('course_management::admin.routine.list') }} :: {{ __('course_management::admin.common.read') }}
@endsection
        ...
        <div class="card">
            <div class="card-header text-primary custom-bg-gradient-info">
                ...
                <div class="card-tools">
                    <div class="btn-group">
                        <a href="{{route('course_management::admin.routines.edit', [$routine->id])}}" class="btn btn-sm btn-outline-primary btn-rounded">
                            <i class="fas fa-plus-circle"></i> {{ __('course_management::admin.common.edit') }}
                        </a>
                        <a href="{{route('course_management::admin.routines.index')}}" class="btn btn-sm btn-outline-primary btn-rounded">
            ...
            <div class="row card-body">
                ...
                <div class="col-md-6 custom-view-box">
                    <p class="label-text">{{__('course_management::admin.routine.training_center')}}</p>
                    <div class="input-box">
