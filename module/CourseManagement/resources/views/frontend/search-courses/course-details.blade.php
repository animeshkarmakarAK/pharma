                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 custom-view-box">
                                <p class="label-text">{{__('course_management::admin.course.institute_address')}}</p>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{__('course_management::admin.course.course_session_list')}}</h2>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-sm">
                                    <thead>
                                    <tr>
                                        <th>{{__('course_management::admin.course.enrollment_start')}}</th>
                                        <th>{{__('course_management::admin.course.enrollment_end')}}</th>
                                        <th>{{__('course_management::admin.course.class_start')}}</th>
                                        <th>{{__('course_management::admin.course.total_seat')}}</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @elseif($session->course_start_date && $session->course_start_date->gt(now()))
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    >{{__('course_management::admin.course.apply')}}
                                                    </button>
                                                </td>
                                            @endif
                                        </tr>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="alert alert-warning">
                                    {{__('course_management::admin.course.not_found')}}.
                                </div>
                            </div>
                        </div>
                    @endif
