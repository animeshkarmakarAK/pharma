            ...
            <table id="background-watermark">
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 30%;"><span style="font-size: 20px;padding-bottom: 5px">No</span>
                                    <span
                                        style="border-bottom: 2px dotted;font-size: 16px;">{{ !empty($youthInfo)? $youthInfo['register_no']:'' }}</span>
                                </td>
                                ...
                                <td style="width: 30%;margin-left: 20px;"><span style="font-size: 20px; padding-bottom: 5px">Date: </span>
                                    <span
                                        style="border-bottom: 2px dotted;font-size: 16px;"> {{ !empty($youthInfo)? $youthInfo['to_date']:'' }}</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="text-align: left; padding-bottom: 50px">
                        <img src="{{ file_exists(public_path($youthInfo['course_coordinator_signature']))? public_path($youthInfo['course_coordinator_signature']):'' }}" height="40px">
                        <p style="font-size: 16px; font-weight: bold;">COURSE COORDINATOR</p>
                    </td>
                    <td></td>
                    <td colspan="2" style="text-align: right; padding-bottom: 50px">
                        <img src="{{ file_exists(public_path($youthInfo['course_director_signature']))? public_path($youthInfo['course_director_signature']):'' }}" height="40px">
