                ...
                <div class="card">
                    <div class="card-header text-primary custom-bg-gradient-info">
                        ...
                        <div class="card-tools">
                            <a href="{{route('govt_stakeholder::admin.job-sectors.index')}}"
                    ...
                    <div class="card-body">
                        <form
                            action="{{$edit ? route('govt_stakeholder::admin.job-sectors.update', $jobSector->id) : route('govt_stakeholder::admin.job-sectors.store')}}"
