...
<div class="wrapper">
    @yield('header', \Illuminate\Support\Facades\View::make('core.front-end.layouts.header'))
    ...
    @yield('footer', \Illuminate\Support\Facades\View::make('core.front-end.layouts.footer'))
</div>
