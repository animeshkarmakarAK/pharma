...
class AddForeignKeysToTraineeBatchesTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('trainee_batches', function (Blueprint $table) {
            ...
            //$table->foreign('trainee_id', 'trainee_batches_fk_trainee_id')->references('id')->on('trainees')->onUpdate('CASCADE')->onDelete('CASCADE');
            //$table->foreign('trainee_registration_id', 'trainee_batches_fk_trainee_registration_id')->references('id')->on('trainee_registrations')->onUpdate('CASCADE')->onDelete('CASCADE');
        });
    }
